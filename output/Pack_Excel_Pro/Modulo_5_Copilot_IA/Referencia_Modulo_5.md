...
## 1. Checklist para usar Copilot en Excel

Antes de usar Microsoft 365 Copilot en Excel, verifica que cumples con todos los requisitos. Marca cada punto:


| # | Requisito | Detalle |
| --- | --- | --- |
| 1 | Licencia activa | Microsoft 365 Business/Enterprise con add-on Copilot habilitado. |
